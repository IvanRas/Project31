...
class CourseAPITestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.course_url = reverse("college:course-detail", args=[self.course.id])
        self.subscription_url = reverse("college:subscription")
...
class LessonAPITestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.lesson_url = reverse("college:lesson-detail", args=[self.lesson.id])
